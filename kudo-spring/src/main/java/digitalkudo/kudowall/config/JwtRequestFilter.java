package digitalkudo.kudowall.config;
...
@Component
public class JwtRequestFilter extends OncePerRequestFilter {//toute requette envoyer est intercepter par cette classe pour voir si le token est valid
    @Autowired
